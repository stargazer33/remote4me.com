...
cat $JSP/bootstrap-table.min.js $JSP/bootstrap-table-en-US.min.js $JSP/handlebars.runtime-v4.0.12.min.js $JSP/lunr.min.js > $JSP/jobad-list.js
uglifyjs --compress -- $JSP/render_jobad_list_filter.js >> $JSP/jobad-list.js

# write $CSP/default.css
cleancss -O2 -o $CSP/default.css $CSP/font-open-sans.css $CSP/style.css $CSP/font-awesome.css $CSP/userstyle.css
